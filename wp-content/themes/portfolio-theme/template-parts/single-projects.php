...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    <section class="single_project" itemscope itemtype="http://schema.org/CreativeWork">
        <div class="single_project_wrapper wrapper">
            ...
            <div class="single_project_header">
                <div class="project_header_content">
                    <div class="project_description" itemprop="description">
                    ...
                    <div class="project_links">
                        <ul>
                            ...
                            <li>
                                <a itemprop="url" class="project_link_item" href="<?= $site; ?>" title="<?= __('Aller sur le site web', 'fr');?>"><?= __('Voir le site web', 'fr');?></a>
                            </li>
                            <?php endif; ?>
                            <?php $github = get_field('github_link'); if( $github ): ?>
                            <li>
                                <a itemprop="url" class="project_link_item" href="<?= $github; ?>" title="<?= __('Aller sur le repo Github du site', 'fr');?>"><?= __('Voir sur Github', 'fr');?></a>
                            </li>
                            <?php endif; ?>
                            <?php $invision = get_field('invision_link'); if( $invision ): ?>
                            <li>
                                <a itemprop="url" class="project_link_item" href="<?= $invision; ?>" title="<?= __('Voir le design sur InVision', 'fr');?>"><?= __('Voir sur InVision', 'fr');?></a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
                <figure class="project_header_img" itemprop="image">
                        ...
                        <ul>
                            <?php foreach( $gallery as $image ):?>
                                <li class="project_img_list">
                                    <img src="<?= $image['url']; ?>" alt="<?= $image['alt']; ?>" width="<?= $image['width']; ?>" height="<?= $image['height']; ?>" itemprop="image">
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                    ...
                    <div class="project_typo_content">
                        ...
                        <div class="project_typo">
                            ...
                            <?php while ( have_rows('project_typo') ) : the_row();
                                ...
                                <li>
                                    <img src="<?= $typo['url']; ?>" alt="<?= $typo['title']; ?>" width="200" height="20">
                                </li>
                             <?php endwhile;?>
                            </ul>
                        </div>
